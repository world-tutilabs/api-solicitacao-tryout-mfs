...
export const makeListByStatusTryoutController = (): Controller => {
  ...
  const dbListByStatusTryout = new DbListByStatusTryout(
    listByStatusTryoutMysqlRepository
  );
  const listTryoutController = new ListByStatusTryoutController(
    dbListByStatusTryout
  );
